...
//		Debug.Log("Reser Shoot AI");
	...
	private DataShootAI[] dataShootAI = new DataShootAI[] {
		...
		new DataShootAI(16.5f, 2.6f, 2.1f, 2.4f, 3f, 0.145f, 0.76f)
		,new DataShootAI(19f, 2.8f, 2.2f, 2.4f, 3f, 0.145f, 1.5f)
		,new DataShootAI(21f, 2.8f, 2.2f, 2.4f, 3f, 0.145f, 1.8f)
